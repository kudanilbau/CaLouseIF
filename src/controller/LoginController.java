...
public class LoginController {
	 ...
	 * {@code UserController}.
	 * <p>
	 * This method attempts to log in the user using the provided credentials. If
	 * the credentials are valid, the user is logged in. Otherwise, an exception is
	 * thrown.
	 * </p>
	 *
	 * @param username the username of the user attempting to log in
	 * @param password the password of the user attempting to log in
	 * @throws Exception if the login credentials are incorrect or an error occurs
	 *                   during login
	 */
...
//			Ke dashboard
	...
	/**
	 * Navigates the user to the registration page when the "Create Account"
	 * hyperlink is clicked.
	 *
	 * @param e the {@code ActionEvent} triggered by the user clicking the create
	 *          account hyperlink
	 */
